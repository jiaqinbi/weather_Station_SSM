...
<div class = "container" >
    ...
    <br><input type="text" id="airpressureData" name="airpressureData" style="display: none;/*visibility: hidden*/"/>
    <h3 style="text-align: center;font-family: 隶书;font-size: 35pt;">实时气压可视化演示</h3>
...
<script src="http://cdn.highcharts.com.cn/highcharts/highcharts-zh_CN.js" type="text/javascript" ></script>
    ...
    function autorefresh(){
        $.ajax({
            ...
            success:function(data){
                //console.log(data[0].air_pressure);

...
<div class = "container" >
    ...
    <br><input type="text" id="humidityData" name="humidityData" style="display: none;/*visibility: hidden*/"/>
    <h3 style="text-align: center;font-family: 隶书;font-size: 35pt;">实时湿度可视化演示</h3>
